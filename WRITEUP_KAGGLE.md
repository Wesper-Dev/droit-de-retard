...
| Native function calling | Three selected tools, validated args, test suite | Validated — 3 tool calls per run, 0 rejected, 2 tool-result round trips, 47/47 tests |
